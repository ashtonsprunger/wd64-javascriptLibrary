function fetchAllFromAuthRoute(){
    const fetch_url = 'http://localhost:4000/authtest/getall';
...
function postToAuthRouteCreate(){
    const fetch_url = 'http://localhost:4000/authtest/create';
    const accessToken = localStorage.getItem('SessionToken');
...
function getOneByUser(){
    ...
    const fetch_url = `http://localhost:4000/authtest/${postIdNumber}`;
    const accessToken = localStorage.getItem('SessionToken');
...
function updateItem(){
    ...
    const fetch_url = `http://localhost:4000/authtest/update/${postIdNumber}`;
    const accessToken = localStorage.getItem('SessionToken')
...
function showCurrentData(e){
    const fetch_url = `http://localhost:4000/authtest/${e.value}`;
    const accessToken = localStorage.getItem('SessionToken');
...
function deleteItem(){
    ...
    const fetch_url = `http://localhost:4000/authtest/delete/${postIdNumber}`;
    const accessToken = localStorage.getItem('SessionToken');
...
function deleteItemById(paramNum){
    const fetch_url = `http://localhost:4000/authtest/delete/${paramNum}`;
    const accessToken = localStorage.getItem('SessionToken');
...
function fetchFromOneDisplayData(){
    const url = 'http://localhost:4000/authtest/getall';
    const accessToken = localStorage.getItem('SessionToken');
